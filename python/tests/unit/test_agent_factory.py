...
class TestAgentFactory:
    ...
    @pytest.fixture
    def factory_config(self, mock_vector_store, mock_config_manager, sample_agent_configs):
    ...
    def test_create_agent_default(self, mock_vector_store):
    ...
    def test_create_agent_with_custom_sources(self, mock_vector_store):
    ...
    @pytest.mark.asyncio
    async def test_create_agent_by_id(self, mock_vector_store, mock_config_manager):
    ...
    @pytest.mark.asyncio
    async def test_create_agent_by_id_not_found(self, mock_vector_store, mock_config_manager):
    ...
    async def test_get_or_create_agent_cache_miss(self, agent_factory):
        ...
        with patch.object(agent_factory, 'create_agent_by_id') as mock_create:
            ...
            mock_create.assert_called_once_with(
                ...
                history=history,
                agent_id=agent_id,
                vector_store=agent_factory.vector_store,
    ...
    @pytest.mark.asyncio
    async def test_create_pipeline_from_config_general(self, mock_vector_store):
    ...
    @pytest.mark.asyncio
    async def test_create_pipeline_from_config_scarb(self, mock_vector_store):
...
class TestCreateAgentFactory:
    ...
    def test_create_agent_factory_defaults(self):
        ...
        with patch('cairo_coder.core.agent_factory.ConfigManager') as mock_config_class:
            ...
            factory = create_agent_factory(mock_vector_store)
    ...
    def test_create_agent_factory_with_custom_config(self):
    ...
    def test_create_agent_factory_custom_agent_override(self):
