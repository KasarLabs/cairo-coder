...
- Smithers intro: [https://smithers.sh/introduction](https://smithers.sh/introduction)
- MCP/SQLite tool pattern: [https://smithers.sh/guides/mcp-integration](https://smithers.sh/guides/mcp-integration)
